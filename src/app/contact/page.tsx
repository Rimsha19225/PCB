    ...
    <div>
      ...
      <div className='w-[70%] h-[72vh] ml-56 mt-6 bg-green-200 rounded-3xl p-8 border-solid border-8 border-green-900 shadow-2xl shadow-slate-400'>
        <form action="Post">
            ...
            <legend className='text-xl font-bold text-green-900 mt-2'>Gender:</legend>
            <span>
              Male
            ...
            <input type="text" placeholder='write Message....' className='w-[100%] h-[10vh] p-2 rounded-xl' />
            <Link href="mailto:adeelarshad8900@gmail.com"><button className='w-28 p-2 mt-4 bg-white rounded-2xl text-green-900 font-bold'>Submit</button></Link>
        </form>
      </div>
    </div>
  )
